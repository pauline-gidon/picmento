...
class AjouterPhotosSouvenirTribu extends Controller {
	...
	function getResult() {
        ...
        if(!is_null($article)){
            ...
            if($auteur_article == $_SESSION["auth"]["id"]){
                $id_article = $article->getIdArticle();
                $titre_article = $article->getTitreArticle();
                //je compte le nombre de photos associé l'article pour bloquer si plus de 3
                            ...
                            $new_medias = new Medias([
                                ...
                                if($manager1->insertMediasHasArticle($id_article,$new_id_medias)){
                                    ...
                                    if(($form->isSubmit("addPhoto")) && ($form->isValid())){
                                        ...
                                        header("location: tribu-ajouter-photos-souvenir-".$id_article."");
                                        exit();
                                    }
